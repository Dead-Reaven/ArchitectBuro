...
const sliders = [
	{ src: img1, p: 'архітектура', h: 'ЖК Мій Дім' },
	{ src: img2, p: 'архітектура', h: 'ЖК Оазіс' },
	{ src: img3, p: `об'єктний дизайн`, h: 'Стіл Dubai' },
	{ src: img4, p: `об'єктний дизайн`, h: 'Комод Europe' },
]
</script>
	...
	<main>
		<section>
			...
			>
				...
				>
					<div
						class="absolute w-full left-0 h-full object-cover bg-[#E3A02D]"
					/>
					<img
						:src="src"
					...
					<div
						class="z-10 h-full container max-w-content pt-[125px] flex flex-col justify-around relative"
					>
						<!-- textcontainer -->
						<div class="shrink">
							<p>{{ h }}</p>
